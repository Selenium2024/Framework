...
public class AppConstants {
	...
	public static final String ACCOUNR_PAGE_TITLE = "My Account";
	...
	public static final List<String> Account_PAGE_HEADER_LIST = Arrays.asList("My Account", "My Orders", "My Affiliate Account",
			"Newsletter");
